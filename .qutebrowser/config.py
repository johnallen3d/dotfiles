...
# config.source('colors/onedark.py')
config.source('colors/tkxs.py')
...
c.aliases = {
  ...
  'q': 'quit',
  'wq': 'quit --save',
  'safari': 'spawn open -a Safari {url}'
}
...
## Type: QssColor
# c.colors.statusbar.normal.bg = '#303E47'
...
## Type: ShellCommand
# c.editor.command = ['/usr/local/bin/nvim', '-f', '{file}']
c.editor.command = ['kitty', '-e', 'bash', '-c', '/usr/local/bin/nvim -f {}']
...
c.url.searchengines = {
  ...
  'amz': 'http://smile.amazon.com/s/?tag=httpmariec-20&link_code=wsw&_encoding=UTF-8&search-alias=aps&field-keywords={}&Submit.x=0&Submit.y=0&Submit=Go',
  'ao': 'https://smile.amazon.com/gp/your-account/order-history/ref=oh_aui_search?opt=ab&search={}',
  'ddg': 'http://duckduckgo.com/?q={}',
  'dkr': 'https://hub.docker.com/search/?isAutomated=0&isOfficial=0&page=1&pullCount=0&q={}&starCount=0',
  'gh': 'http://github.com/search?q={}',
  'imdb': 'http://www.imdb.com/find?q={}&s=all',
  'map': 'https://maps.google.com/maps?hl=en&authuser=0&q={}&ie=UTF-8',
  'maps': 'https://maps.google.com/maps?hl=en&authuser=0&q={}&ie=UTF-8',
  'ph': 'http://phish.net/song?s={}',
  ...
  'aud': 'https://www.audible.com/search/ref=a_hp_tseft?advsearchKeywords={}&filterby=field-keywords'
}
