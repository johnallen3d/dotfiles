...
-- I've commented out this file in an attmempt to speed things up]
-- /usr/local/Cellar/neovim/HEAD-615e03c/share/nvim/runtime/syntax/ruby.vim
--
...
opt("o", "pumheight", 10) -- show 10 items in auto-complete
-- opt("o", "updatetime", 1000) -- delay 1s before trigginer update
...
-- Window
-- opt('w', 'relativenumber', true)       -- show row number relative to cursor position
...
-- cmd("set cmdheight=1")
-- consider changing back to:
cmd("set cmdheight=0")
-- e.g. the hit-enter messages in DBUI
